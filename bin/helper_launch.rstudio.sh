...
DATA="/public/groups/kimlab/"${PROJ}"/data:/home/"${USER}"/proj/data"
NOTEBOOKS="/public/groups/kimlab/"${PROJ}"/notebooks:/home/"${USER}"/proj/notebooks"
MANUSCRIPT="/public/groups/kimlab/"${PROJ}"/manuscript:/home/"${USER}"/proj/manuscript"
BIN="/public/groups/kimlab/"${PROJ}"/bin:/home/"${USER}"/proj/bin"
...
GIT_CONFIG="/public/home/"${USER}"/.gitconfig:/home/"${USER}"/.gitconfig"
