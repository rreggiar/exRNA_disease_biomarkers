...
salmon_quant$quant_meta <- parse.tximeta.quant.metadata(salmon_quant)

ucsc.rmsk.salmon_quant <- load.tximeta.object.list('ucsc.rmsk.salmon', 
                                                   output_data.dir = output_data.dir)

ucsc.rmsk.salmon_quant$quant_meta <- parse.tximeta.quant.metadata(ucsc.rmsk.salmon_quant)

process.aware.salmon_quant <- load.tximeta.object.list('process.aware.salmon', 
                                                       output_data.dir = output_data.dir)

process.aware.salmon_quant$quant_meta <- parse.tximeta.quant.metadata(process.aware.salmon_quant)
```
...
subset.tximeta.se <- function(se,se_quant_meta) { 
  
  sub_se <- 
    SummarizedExperiment::subset(se, select = !colData(se)$names %in% qc_fails)
  
  sub_se
  
}

salmon_quant$bioIvt_panc_salmon$txi <- 
  subset.tximeta.se(salmon_quant$bioIvt_panc_salmon$txi)

salmon_quant$bioIvt_panc_salmon$gxi <- 
  subset.tximeta.se(salmon_quant$bioIvt_panc_salmon$gxi)

salmon_quant$quant_meta$bioIvt_panc_salmon <- 
  salmon_quant$quant_meta$bioIvt_panc_salmon[! salmon_quant$quant_meta$bioIvt_panc_salmon$sample %in% qc_fails, ]

ucsc.rmsk.salmon_quant$bioIvt_panc_ucsc.rmsk.salmon$txi <- 
  subset.tximeta.se(ucsc.rmsk.salmon_quant$bioIvt_panc_ucsc.rmsk.salmon$txi)

ucsc.rmsk.salmon_quant$bioIvt_panc_ucsc.rmsk.salmon$gxi <- 
  subset.tximeta.se(ucsc.rmsk.salmon_quant$bioIvt_panc_ucsc.rmsk.salmon$gxi)

ucsc.rmsk.salmon_quant$quant_meta$bioIvt_panc_ucsc.rmsk.salmon <- 
  ucsc.rmsk.salmon_quant$quant_meta$bioIvt_panc_ucsc.rmsk.salmon[! ucsc.rmsk.salmon_quant$quant_meta$bioIvt_panc_ucsc.rmsk.salmon$sample %in% qc_fails, ]

process.aware.salmon_quant$bioIvt_panc_process.aware.salmon$txi <- 
  subset.tximeta.se(process.aware.salmon_quant$bioIvt_panc_process.aware.salmon$txi)

process.aware.salmon_quant$bioIvt_panc_process.aware.salmon$gxi <- 
  subset.tximeta.se(process.aware.salmon_quant$bioIvt_panc_process.aware.salmon$gxi)

process.aware.salmon_quant$quant_meta$bioIvt_panc_process.aware.salmon <- 
  process.aware.salmon_quant$quant_meta$bioIvt_panc_process.aware.salmon[! process.aware.salmon_quant$quant_meta$bioIvt_panc_process.aware.salmon$sample %in% qc_fails, ]
...
salmon_quant$analysis_set$panc_ctrl_gene <-
  SparseSummarizedExperiment::cbind(salmon_quant$bioIvt_panc_salmon$gxi,
                                    salmon_quant$pittsburgh_ctrl_salmon$gxi)

salmon_quant$analysis_set$covid_ctrl_gene <-
  SparseSummarizedExperiment::cbind(salmon_quant$bioIvt_covid_salmon$gxi,
                                    salmon_quant$pittsburgh_ctrl_salmon$gxi)

salmon_quant$analysis_set$panc_ctrl_covid_gene <- 
  SparseSummarizedExperiment::cbind(salmon_quant$analysis$panc_ctrl_gene,
                                    salmon_quant$bioIvt_covid_salmon$gxi)
