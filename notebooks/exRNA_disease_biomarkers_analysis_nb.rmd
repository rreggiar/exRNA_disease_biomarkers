...
assay(ucsc.rmsk.salmon_quant$analysis_set$ctrl_panc_covid$gxi, 'counts')[, 'panc.7.1.1', drop = F]

ucsc.rmsk.salmon_quant$analysis_set$ctrl_panc_covid$deseq$[, 'panc.7.1.1', drop = F] %>% head() rownames_to_column('Gene ID') %>% head()
