...
imap(elife_rmsk_quant[names(elife_rmsk_quant) != 'rmsk'], function(analysis_set, name){
  ...
  analysis_set$deseq$de_out %>%
    filter(padj < 0.01, log2FoldChange < -0.75,
  ...
  ggplot(aes(set)) + 
  geom_bar() + 
  geom_text(stat='count', aes(label=after_stat(count)), vjust=-.5, size = txt.mm_to_pts(1)) +
  xlab('') +
...
de_out_list <- list(elife_rmsk_quant$colorectal_healthy$deseq$de_out,
                 elife_rmsk_quant$liver_healthy$deseq$de_out,
...
wrap_plots(plt_list[[1]] + ggtitle('colorectal cancer'),
           plt_list[[2]] + ggtitle('liver cancer'),
           plt_list[[3]] + ggtitle('lung cancer'),
           plt_list[[4]] + ggtitle('esophagus cancer'),
           plt_list[[5]] + ggtitle('stomach cancer'),
           guide_area(),
           wrap_elements(full = fig.3E.plt + ylim(0,200) + ggtitle('downregulated TEs')),
           wrap_elements(full = fig.3F.plt + ylim(0,200) + ggtitle('upregulated TEs')),
