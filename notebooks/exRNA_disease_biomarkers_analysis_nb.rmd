...
## load_tximeta_obj
```{r}
import::from(.directory = r_code.dir, .from = 'helper_analysisFunctions.R', load.tximeta.object.list)
...
process.aware.salmon_quant <- load.tximeta.object.list('process.aware.salmon', 
                                                       output_data.dir = output_data.dir)
```
## build_quant_meta_data
```{r}
tximeta_quant_cols_of_interest <- 
...
imap(salmon_quant, function(data, project) {
...
tximeta_quant_row_names <- salmon_quant$bioIvt_covid_salmon$gxi$names

salmon_quant$bioIvt_covid_salmon$gxi@metadata$quantInfo[names(salmon_quant$bioIvt_covid_salmon$gxi@metadata$quantInfo) %in% tximeta_quant_cols_of_interest] %>% as.data.frame() %>% mutate(names = tximeta_quant_row_names) -> tmp
...
salmon_quant$bioIvt_panc_salmon$gxi@metadata$quantInfo
```
