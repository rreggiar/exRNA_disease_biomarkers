...
ucsc_rmsk_biotype_summary %>% 
  ...
  ggpubr::stat_compare_means(method = 'wilcox', comparisons = list(c('covid', 'ctrl'), c('panc', 'ctrl'), c('covid', 'panc'))) +
...
wrap_plots(biotype_count, plt_SN2E.plt) + plot_annotation(tag_levels = 'A') -> biotype_plt
