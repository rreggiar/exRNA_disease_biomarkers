...
ctrl_hex_to.plt %>% 
  ...
  scale_y_continuous(breaks = c(50,100,200,300,400), limits = c(0,400)) +
  scale_x_continuous(breaks = c(50,100,200,300,400), limits = c(0,400)) +
  scale_fill_viridis_c(option = 'viridis', direction = 1, name = 'scaled cpm', breaks = c(0,1), guide = 'none') -> plt_ND_1.plt
...
panc.7.1.1_hex_to.plt %>% 
  ...
  guides(fill = guide_colorbar(title.position = 'left', title.vjust = 1)) -> plt_ND_2.plt
...
ctrl.6.1.5_nanopore_hex_to.plt %>% 
  ...
  scale_y_continuous(breaks = c(50,100,200,300,400), limits = c(0,400)) +
  scale_x_continuous(breaks = c(50,100,200,300,400), limits = c(0,400)) -> plt_NE_1.plt
...
panc.7.1.1_nanopore_hex_to.plt %>% 
  ...
  scale_fill_viridis_c(option = 'viridis', direction = 1, name = 'scaled cpm', guide = 'none') +
  scale_y_continuous(breaks = c(50,100,200,300,400), limits = c(0,400)) +
  scale_x_continuous(breaks = c(50,100,200,300,400), limits = c(0,400)) -> plt_NE_3.plt
...
ctrl_hex_to.plt %>% 
  ...
  theme(legend.position = c(0.95,0.125), legend.direction = 'horizontal')
...
panc_hex_to.plt %>% 
  ...
  # ggforce::facet_col(~condition) +
  scale_fill_viridis_c(option = 'viridis', direction = 1, name = 'scaled cpm') +
  theme(legend.position = c(0.95,0.125), legend.direction = 'horizontal') -> plt_SNA_2.plt
```
## Fig_SNB
```{r}
tmp %>% 
...
panc_hex_to.plt %>% 
  ...
  # ggforce::facet_col(~condition) +
  scale_fill_viridis_c(option = 'viridis', direction = 1, name = 'scaled cpm') +
  theme(legend.position = c(0.95,0.125), legend.direction = 'horizontal') -> plt_SNB.plt
```
