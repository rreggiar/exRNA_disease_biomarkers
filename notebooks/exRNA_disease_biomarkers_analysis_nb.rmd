...
ucsc.rmsk.salmon_quant <-
  parse.tximeta.quant.metadata(ucsc.rmsk.salmon_quant)
...
sample_meta_data$`2022.01.14_combined_meta_data.csv` %>% 
  select('sample' = patient, 'sample_sku_patient_gender' = sex, 'diagnosis' = condition)

discovery_meta_data %>% 
  select(sample, sample_sku_patient_gender, diagnosis)
