...
rbind(
  internal_quant$ucsc_rmsk_quant$quant_meta,
  external_quant$ucsc_rmsk_quant$quant_meta,
  gut_quant$ucsc_rmsk_quant$quant_meta[, colnames(gut_quant$ucsc_rmsk_quant$quant_meta) %in% colnames(external_quant$ucsc_rmsk_quant$quant_meta)]
) -> united_quant_meta


united_quant_meta %>% 
  merge(united_metadata_df, by = 'sample') -> united_quant_meta

united_gxi_tmp <-
      SparseSummarizedExperiment::cbind(internal_quant$ucsc_rmsk_quant$gxi,
...
meta_analysis_set <- 
  build.analysis.set(se_list = internal_quant,
                     se_1 = 'ucsc.rmsk.quant',
                     analysis_set_2 = external_quant$ucsc_rmsk_quant,
                     sample_meta_in = united_metadata_df)
##
