...
elife_select_list <-
  filter(
    external_quant$ucsc_rmsk_quant$quant_meta,
    !sample %in% elife_merge_meta_for_filt$sample
  ) %>% 
  pull(sample)
...
internal_quant$origPanc_normal$quant_meta <-
  merge(
    internal_quant$origCovid_normal$quant_meta,
    original_normal_meta_data,
    by = 'sample'
...
internal_quant$panc_normal$quant_meta <-
  merge(
    internal_quant$panc_normal$quant_meta,
    discovery_meta_data,
    by = 'sample'
...
internal_quant$esoph_normal$quant_meta <-
  merge(
    internal_quant$esoph_normal$quant_meta,
    discovery_meta_data,
    by = 'sample'
...
internal_quant$preTx$quant_meta <-
  merge(
    internal_quant$preTx$quant_meta,
    discovery_meta_data,
    by = 'sample'
...
internal_quant$postTx$quant_meta <-
  merge(
    internal_quant$postTx$quant_meta,
    discovery_meta_data,
    by = 'sample'
