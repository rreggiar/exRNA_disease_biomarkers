...
panc_nanopore_read_length.df %>% 
  ...
  ylab('proportion of nanopore biotype/clade fragment lengths') + xlab('nanopore fragment length') +
...
ctrl.6.1.5_nanopore_hex_to.plt %>% 
  ...
  xlab('nanopore SINE fragment length') + 
...
panc.6.1.1_nanopore_hex_to.plt %>% 
  ...
  xlab('avg. observed SINE fragment length') + ylab('expected insert len') +
