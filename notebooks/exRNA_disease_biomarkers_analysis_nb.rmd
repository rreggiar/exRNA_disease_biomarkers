...
surv.plt$plot + ggtitle('panc gencode up') -> plt_surv_A.plt
...
surv.plt$plot + ggtitle('panc TE down') -> plt_surv_D.plt
...
surv.plt$plot + ggtitle('Ox. Phos') -> plt_surv_F.plt
...
surv.plt$plot + ggtitle('MYC Targets') -> plt_surv_G.plt
